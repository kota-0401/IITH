...
function closeSideOfAdminLogin() {
    document.getElementById("adminLogin").className = 'adminLogin';
}
function e() {
    document.getElementById("customerLogin").className += ' displaySidee';
}
function closeSideOfCustomerLogin() {
    document.getElementById("customerLogin").className = 'customerLogin';
}
var adminAccount = {
    email: "admin@avdbasket.com",
    password: "admin123"
}
...
function signUpCustomer() {
    ...
    var a = localStorage.setItem("Customer_Account", JSON.stringify(customerAccount));
    document.getElementById("display").style.display = 'block';
    setTimeout(function () {
        location = 'customerpanel.html'
    }, 2000)
...
function customerlogin() {
    var email = document.getElementById("emailM").value;
    var password = document.getElementById("passwordM").value;
    var b = JSON.parse(localStorage.getItem("Customer_Account"));
    
     if (email === "cs21btech11029@iith.ac.in" && password === "vignankota") {
         document.getElementById("display1").style.display = 'block';
         setTimeout(function () {
             location = 'customerpanel.html'
         }, 2000)
     }
     else if (email === "cs21btech11031@iith.ac.in" && password === "akhilakumbha") {
        document.getElementById("display1").style.display = 'block';
        setTimeout(function () {
            location = 'customerpanel.html'
        }, 2000)
    }
    else if (email === "cs21btech11035@iith.ac.in" && password === "davidmaloth") {
        document.getElementById("display1").style.display = 'block';
        setTimeout(function () {
            location = 'customerpanel.html'
        }, 2000)
...
function sellProduct(id) {
    ...
    for (var i = 0; i < quantity.length; i++) {
        ...
        if (quantity > 10) {
            document.getElementById("errorinSaleInfo").innerHTML = "Quantity Limit is 1 to 10.";
            document.getElementById("errorinSaleInfo").style.display = 'block';
            document.getElementById("quantityOfProduct").value = "";
            flag = true;
        }
                ...
                for (var key2 in products[key]) {
                    if (nameProduct === key2) {
                        ...
                        swal({
                            type: "success",
                            title: "HURRAY!",
                            text: "Your order " + products[key][key2].name + " has been placed successfully.  Total Price : " + quantity + "X" + products[key][key2].price + "= RS." + quantity * products[key][key2].price + ".  THANK YOU!  ",
